...
export function AuthModal({ open, onClose, onSuccess, githubAvailable, devLogin }: AuthModalProps) {
              ...
              {mode === "choose" && (
                <Pane key="choose">
                  ...
                  <div style={{ display: "flex", flexDirection: "column", gap: 10, marginTop: 22 }}>
                    ...
                    {!githubAvailable && !devLogin && (
                      <div style={{ fontSize: 12.5, color: "var(--muted)", lineHeight: 1.6 }}>
                        Методы входа не настроены. Задайте <code style={{ color: "var(--mercury-a)" }}>GITHUB_CLIENT_ID</code> или
                        <code style={{ color: "var(--mercury-a)" }}> ALLOW_DEV_LOGIN=1</code> в <code>.env</code>.
                      </div>
                    )}
                  </div>
                </Pane>
