...
_TEAM_PREAMBLE = (
    ...
    "Код, HTML, CSS, JS, содержимое файлов, тексты документов СОЗДАВАЙ только ВЫЗОВОМ "
...
ROLE_PROMPTS = {
    ...
    "developer": (
        ...
        "• Хостируемый лендинг/сайт → статика в site/ (HTML/CSS/JS)\n"
        ...
        "• site/index.html, site/css/style.css, site/js/script.js\n"
    ...
    "designer": (
        ...
        "премиальные сайты. Твой стандарт — сайты, которые выглядят как Awwwards-winners.\n"
        "🚫 НЕ используй и НЕ исследуй Tilda/Webflow/Wix/конструкторы — даже если так в ТЗ. "
        "Пишешь СОБСТВЕННЫЙ HTML/CSS/JS-код. НЕ вызывай web_search про конструкторы — сразу пиши код.\n"
        "Что ты делаешь:\n"
        "• ПОЛНОЦЕННЫЕ многостраничные сайты в папке site/: site/index.html, site/css/style.css, "
        "site/js/script.js, доп. страницы по необходимости. Используй ПАПКИ и несколько файлов.\n"
        ...
        "чистый JS (canvas API), parallax-скроллинг, анимации на GSAP или CSS keyframes, "
        ...
        "• Типографика: Google Fonts (Montserrat, Inter, Playfair Display). "
        "Крупные заголовки, font-weight 700–900.\n"
