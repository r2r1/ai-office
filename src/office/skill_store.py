...
Встроенные скиллы живут в коде (skill_library.py). Здесь — механизм, который даёт
офису «поставить любой скилл из любого источника» БЕЗ правки кода: скилл кладётся
файлом в папку, а офис подхватывает его на лету.
